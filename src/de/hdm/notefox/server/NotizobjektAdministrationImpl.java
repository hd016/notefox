...
/**
 * <p>
 * Implementierungsklasse des Interface <code>NotefoxAdministration</code>. Diese
 ...
 * sind:
 * <ol>
 * <li>{@link NotefoxAdministration}: Dies ist das <em>lokale</em> - also
 * Server-seitige - Interface, das die im System zur Verfügung gestellten
 * Funktionen deklariert.</li>
 * <li>{@link NotefoxAdministrationAsync}: <code></code> und
 * <code>NotefoxAdministration</code> bilden nur die Server-seitige Sicht der
 ...
 * {@link NotefoxAdministrationAsync}.</li>
 * <li> {@link RemoteServiceServlet}: Jede Server-seitig instantiierbare und
 * Client-seitig über GWT RPC nutzbare Klasse muss die Klasse
 * <code>RemoteServiceServlet</code> implementieren. Sie legt die funktionale
 * Basis für die Anbindung von <code></code> an die Runtime
 ...
 * auch die Hinweise in {@link #delete(Notiz)} Einzig nachvollziehbares
 ...
 * </p>
 * 
 * @see NotefoxAdministration
 * @see NotefoxAdministrationAsync
