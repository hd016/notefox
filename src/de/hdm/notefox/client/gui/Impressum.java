...
public class Impressum extends HTML {
	...
	public Impressum() {
		...
		"<div class= 'Impressum'>" + "<b>" + "Angaben gemäß §5 Telemediengesetz </b></br></br>"
				+ "Hochschule der Medien" + "</br>" + "<b> Wirtschaftsinformatik und digitale Medien </b></br>"
				+ "Nobelstrasse 10</br>" + "70569 Stuttgart </br></br>" + "Kontakt</br>Telefon: +49 711 8923 10</br>"
