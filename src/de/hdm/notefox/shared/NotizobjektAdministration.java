...
public interface NotizobjektAdministration extends RemoteService {
  ...
  /**
   * <p>
   * Auslesen sÃ¤mtlicher mit dieser Notiz in Verbindung stehenden
   * Notizquellen. 
   * </p>
   * 
   ...
   * @throws IllegalArgumentException
   */
  public ArrayList<Datum> nachAllenFaelligkeitenDesNutzersSuchen(Notiz no)
      throws IllegalArgumentException;
  
  /**
   * <p>
   * Auslesen sÃ¤mtlicher mit diesem Notizbuch in Verbindung stehenden
   * Notizen. 
   * </p>
   * 
  ...
  /**
   * LÃ¶schen der Ã¼bergebenen Notizquelle.
   * 
   * @param t die zu lÃ¶schende Notizquelle
   * @throws IllegalArgumentException
   */
  public void loeschenNotizquelleVon(Notizquelle nq) throws IllegalArgumentException;
  
  /**
   * LÃ¶schen der Ã¼bergebenen Faelligkeiten.
   * 
   * @param t die zu lÃ¶schende Faelligkeit
   * @throws IllegalArgumentException
   */
